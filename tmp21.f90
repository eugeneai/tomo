...
!----------------
      ...
      CALL Proj_Summa_W_Harm(WUnit,LL,NJ,NNMAX,PPM,ALPHAM,BETAM, &
...
!          CALL Vec_Line(YMVEC,YMVEC3,LN,NTEN)
          ...
          CALL RightPart_Full(WUnit,LL,NNMAX,NTEN,     &
...
!------------------------------------------------------------
      ...
      SUBROUTINE Proj_Summa_W_Harm(WUnit,LL,NJ,NNMAX,PPM,ALPHAM,BETAM, &
...
!------------------------------------------------------
      ...
      SUBROUTINE RightPart_Full(WUnit,LL,NNMAX,NTEN,     &
...
!           MU_W=LMAX*(IJ-1)*NNMAX+IIC  
           ...
           YM= RightPart_Term_RE(WUnit,PROJ,I,J,LL,N,L22,M-1,NNMAX,  &
                PPM,ALPHAM,BETAM,GAMMAM,        &
...
!           MU_V=LMAX*(IJ-1)*NNMAX+IIS
           ...
           YM=RightPart_Term_IM(WUnit,PROJ,I,J,LL,N,L22,M,NNMAX,  &
                PPM,ALPHAM,BETAM,GAMMAM,        &
                NPP,NALPHA,NBETA,NGAMMA,NTEN,PAR)
...
!--------------------------------------------------
     ...
     FUNCTION RightPart_Term_RE(WUnit,PROJ,IC,JC,LL,N,L,M,NNMAX,  &
                PPM,ALPHAM,BETAM,GAMMAM,        &
                NPP,NALPHA,NBETA,NGAMMA,         &
                NTEN,PAR)
...
!----
          ...
          DO 10 I1=1,NALPHA
             ...
             YYRE=INT_Proj_GNLM_RE(WUnit,PROJ,PPM,NPP,N,L,M,IC,JC, &
...
!--------------------------------------
     FUNCTION RightPart_Term_IM(WUnit,PROJ,IC,JC,LL,N,L,M,NNMAX,  &
                PPM,ALPHAM,BETAM,GAMMAM,        &
                NPP,NALPHA,NBETA,NGAMMA,         &
                NTEN,PAR)
...
!--------------------------------------
      ...
      FUNCTION INT_Proj_GNLM_RE(WUnit,PROJ,PPM,NPP,N1,L1,M1,IC,JC,     &
                             I1,I2,I3,NJ,ALPHA,BETA,GAMMA,PAR)
...
!------------------------------------------------------------
       FUNCTION INT_Proj_GNLM_IM(WUnit,PROJ,PPM,NPP,N1,L1,M1,IC,JC,     &
                        I1,I2,I3,NJ,ALPHA,BETA,GAMMA,PAR)
