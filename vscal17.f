...
!      CALL Summa_W_Harm_Vec(LL,NJ,NNMAX,PPM,ALPHAM,BETAM,
!     #                   GAMMAM,NPP,NALPHA,NBETA,NGAMMA,XM,PROJ)
...
c      BKAPMAX=ATAN2(RRE,DD)
      ...
      DO 85 I4=1,NJ
         ...
         CGAMMA=COS(GAMMA)
         SGAMMA=SIN(GAMMA)
! inverse matrix of the active rotation
!         AA11= CALPHA*CBETA*CGAMMA - SALPHA*SGAMMA
!         AA12= SALPHA*CBETA*CGAMMA + CALPHA*SGAMMA
!         AA13=-SBETA*CGAMMA
!         AA21=-CALPHA*CBETA*SGAMMA - SALPHA*CGAMMA
