...
!        REAL(wp), allocatable::SVZKARE(:),SVZKAIM(:)
        ...
        OPEN(10,FILE ='Data_Input22.dat', ERR=300)
...
60      CONTINUE   
!           write(*,*) 'RightPart_Full:AA,BB'
!           DO 62 III=1,(LL+1)**2*NNMAX*NTEN*NTEN
!           write(*,177) AA(III),BB(III)
!62         CONTINUE
177   FORMAT(2I3)
      RETURN
...
!            CALL POLAR2(XX,YY,ZZ,TETA,PHI)
            ...
            CALL REGN(PHIM,TETAM,RRM,NPHI,NTETA,NRR,PHI,TETA,RRR,EI)
            IF(EI .GT. 0) THEN
            DR(I321,K2)=FUNL3(PHIM,TETAM,RRM,GMM,NPHI,NTETA,NRR,PHI,TETA,RRR,IERR)
